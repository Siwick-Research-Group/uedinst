...
class entype_settings_t(Structure):
    _fields_ = [("EngineType", c_uint), ("DriverType", c_uint)]
...
class extio_settings_t(Structure):
    _fields_ = [("EXTIOSetupFlags", c_uint), ("EXTIOModeFlags", c_uint)]
...
class ctp_settings_t(Structure):
    _fields_ = [("CTPMinError", c_uint), ("CTPFlags", c_uint)]


class uart_settings_t(Structure):
    _fields_ = [("Speed", c_uint), ("UARTSetupFlags", c_uint)]
...
class controller_name_t(Structure):
    _fields_ = [("ControllerName", c_char * 17), ("CtrlFlags", c_uint)]


class nonvolatile_memory_t(Structure):
    _fields_ = [("UserData", c_uint * 7)]


class command_add_sync_in_action_t(Structure):
    _fields_ = [("Position", c_int), ("uPosition", c_int), ("Time", c_uint)]


class command_add_sync_in_action_calb_t(Structure):
    _fields_ = [("Position", c_float), ("Time", c_uint)]


class get_position_t(Structure):
    _fields_ = [("Position", c_int), ("uPosition", c_int), ("EncPosition", c_longlong)]
...
class measurements_t(Structure):
    _fields_ = [("Speed", c_int * 25), ("Error", c_int * 25), ("Length", c_uint)]
...
class debug_read_t(Structure):
    _fields_ = [("DebugData", c_ubyte * 128)]
...
class stage_name_t(Structure):
    _fields_ = [("PositionerName", c_char * 17)]


class stage_information_t(Structure):
    _fields_ = [("Manufacturer", c_char * 17), ("PartNumber", c_char * 25)]
