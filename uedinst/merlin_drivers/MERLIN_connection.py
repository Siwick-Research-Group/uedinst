...
class MERLIN_connection: 
    ...
    def __init__(self, hostname='diamrd', ipaddress ='000', channel = 'cmd',
        ...
        self.listofFloatVars  = ['THSTEP', 'THSTOP', 'THSTART', 'OPERATINGENERGY', 'THRESHOLD7',
                                ...
                                'THRESHOLD1', 'THRESHOLD0','TEMPERATURE','HVBIAS']
    ...
    def startAcqThresholdScan(self, Threshold,  acqTime, ini , end, step, fname='default'):
    ...
    def _GetMatrix(self, chunk) : 
        ...
        matrix =  struct.unpack_from(pixelbits , chunk, Offset) #MPX1offset+Offset-bytes )
    ...
    def receive_Image(self): 
       ...
       # print ' - DEBUG : TRYING TO READ IMAGE 1 '
        ...
        while bytes_recd < self.MSGLEN:
            ...
            if chunk == '': raise RuntimeError(" - ERROR : socket connection broken ")
